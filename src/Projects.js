...
import comingSoonImage from './assets/question.png';
import targetImage from './assets/target.png'; 
import ticTacToeImage from './assets/tictactoe.webp'; 
import amberSearch from './assets/ambersearch.png';

const projects = [
    { id: 1, name: "Archery", cover: archeryCover, info: "When I was first introduced to programming, I learned the basics of Python and object-oriented concepts. For my final project, I created a basic archery game, applying my knowledge of encapsulation, inheritance, collision detection, and loops. I learned how to create objects and manipulate them based on mouse clicks and drags, simulating different game scenarios. By utilizing the foundational techniques I learned in my introductory coding classes, I was able to develop new skills that helped me excel in the course. This project sparked my passion for programming and game development.", position: { x: 440, y: 20 }, icon: targetImage },
    { id: 2, name: "CSEN/COEN Projects", cover: coenProjectsCover1, info: "As I reviewed the basics of C and deepened my understanding of complex programming concepts, I kept a collection of my different CSEN (Computer Science and Enginerring) labs at SCU. These labs allowed me to navigate the various topics I learned and how they can be used effectively. I specifically created a program that collects data about a simulation of the Olympics. My program asks the user to input different countries and medals, printing out a table of the countries and medals that the user chose to add. I utilized many different concepts to create various functions for this code. This included loops, linked lists, pointers, threads, and recursion. ", position: { x: 220, y: 80 }, icon: coenProjectsCover1 },
    { id: 3, name: "Shoots and Ladders", cover: coenProjectsCover2, info: "Using Java, I created my own implementation of Snakes and Ladders to fuel my passion for game development. I applied several programming concepts, including 2D arrays, inheritance, random number generation, and event handling. Initially, I set up a 2D array with different ladder and snake icons. To enhance the game's complexity and reduce predictability, I implemented random number generators to change the positions of the snake and ladder icons each time the game was played. I also used random number generation to determine the magnitude of the user's movement, either climbing the ladder or sliding down the snake. This project deepened my understanding of video game development and allowed me to further explore my love for games.", position: { x: 12, y: 230 }, icon: coenProjectsCover2 },
    { id: 4, name: "My Website", cover: coenProjectsCover3, info: "I learned the basics of HTML and CSS from the President and Vice President of my ACM chapter. During a workshop they hosted, I gained hands-on experience in creating a React app and learned the importance of having a personal website. I began by familiarizing myself with HTML fundamentals and understanding how to work with various functions in .js files. Once I had a solid grasp of the basics, I was able to express my creativity by adding my personal touch to the website and experimenting with its different features.", position: { x: 218, y: 140 }, icon: coenProjectsCover3 },
    { id: 5, name: "Coming Soon", cover: comingSoonImage, info: "Next project coming soon...", position: { x: 390, y: 295 }, icon: comingSoonImage },
    { id: 6, name: "Tic Tac Toe", cover: ticTacToeImage, info: "I created a simple implementation of the classic Tic-Tac-Toe game using Java. In addition to developing the game’s core logic, I found it fascinating to navigate the different aspects of a two-player game. While I had to adhere to a specific set of rules, it was rewarding to apply my knowledge of game development to this project. This experience not only enhanced my understanding of game logic but also improved my skills in UI design.", position: { x: 280, y: 218 }, icon: ticTacToeImage }, 
    { id: 7, name: "AmberSearch AI", cover: amberSearch, info: "During the 2024 INRIX x AWS Hackathon, my team and I developed a project that used AI and Computer Vision to analyze traffic camera footage in response to Amber Alerts. The system took Amber Alert data as input, parsed through images from city cameras, and employed AI to identify the make, model, and color of cars, matching them to the alert description. For the sake of presentation, we built a front-end website where users could manually input Amber Alert information, which would then trigger the AI to process the camera images and return results. Leveraging Claude AI and AWS tools, our team of three placed 11th out of 30 larger teams and made it to the finalists, showcasing the potential of AI to enhance public safety and law enforcement response times. Unfortunately, I lost access to the AI model after 72 hours, though I hope to pursue this project in the future.", position: { x: 160, y: 10 }, icon: amberSearch } 
];
        ...
        <div className="projects">
            ...
            <div className="robot-room">
                ...
                {projects.map((project) => (
                    ...
                    >
                        <img src={project.name === "Archery" ? targetImage : project.icon} alt={project.name} className="project-image" /> {/* Show target image for Archery only */}
                    </div>
                ))}
                {/* Render the walls */}
                {walls.map((wall, index) => (
                    <div
                        ...
                        style={{
                            ...
                            left: `${wall.x1}px`,
                            top: `${wall.y1}px`,
                            width: wall.x1 === wall.x2 ? '5px' : `${Math.abs(wall.x2 - wall.x1)}px`,
                            height: wall.y1 === wall.y2 ? '5px' : `${Math.abs(wall.y2 - wall.y1)}px`,
                            backgroundColor: '#000',
                            zIndex: 10
                        }}
                    />
